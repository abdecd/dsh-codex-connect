...
- 当前唯一已验证的兼容组合是 DSH 插件 API packages `0.1.5-rc.2`、`@earendil-works/pi-ai` `0.85.1` 和 Node.js `^22.19.0 || >=24.0.0`；详见 [compatibility.json](../compatibility.json)。Alpha 4.10 使用 rc.7 的 keyed 插件配置 slot；DSH rc.6 用户应继续使用 Alpha 4.9。
