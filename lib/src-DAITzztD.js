...
function createOpenAICodexAdapter(credentials, resolveAttachments, fastMode, resolveEnabledModels) {
	...
	const provider = {
		...
		getModels: () => {
			...
			return models.some((model) => model.id === OPENAI_CODEX_GPT6_MODEL.id) ? models : [...models, OPENAI_CODEX_GPT6_MODEL];
		}
	};
...
function resolveOpenAICodexSettings(value) {
	return {
		...
		...value,
		enabledModels: value.enabledModels === void 0 ? [...DEFAULT_OPENAI_CODEX_ENABLED_MODELS] : [...value.enabledModels]
	};
}
...
function decodeOpenAICodexSettings(value) {
	...
	return {
		enabledModels: enabledModels === void 0 ? [...DEFAULT_OPENAI_CODEX_ENABLED_MODELS] : [...enabledModels],
		enableSearch,
		enableImageTool,
